...
const Sun: React.FC<SunProps> = memo(
  ({
    ...
    const { qualitySettings, getOptimalQuality, isPerformanceCritical } =
    ...
    const currentQuality = useMemo(() => {
      return getOptimalQuality(currentDistance.current);
    }, [getOptimalQuality, currentDistance.current]);
